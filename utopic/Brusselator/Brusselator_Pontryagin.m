%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Reachability analysis of the system Brusselator with 3 uncertain parameters %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Automatically generated from Brusselator.
% Number of species: 2.
% Number of reactions: 2.
% Coefficients:  1.0 0.
% Perturbed parameters: a in [0.9,1.1], b in [2.3,2.7], c in [1.1,1.6]
...
function Brusselator_Pontryagin()
	...
	% 	The uncertain parameter b belongs to [2.3,2.7];
	% 	The uncertain parameter c belongs to [1.1,1.6];
	...
	f(1) = u(1)+(x(1)*x(1)*x(2)-u(2)*x(1));
	f(2) = u(3)*x(1)-x(1)*x(1)*x(2);


	initpontryagin(f,p,x,u);

	cHeader = { 'a' 'b' 'c'	 };
	pontryagin(maximize,vcoeff,max_iter,delta,uVars,cHeader,gamma,tspan,tspanRev,x0,u_max,u_min,'Brusselator_Pontryagin_max.csv',doPlot);
	pontryagin(minimize,vcoeff,max_iter,delta,uVars,cHeader,gamma,tspan,tspanRev,x0,u_max,u_min,'Brusselator_Pontryagin_min.csv',doPlot);
