%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Reachability analysis of the system bucking with 3 uncertain parameters %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Automatically generated from bucking.
% Number of species: 2.
% Number of reactions: 2.
% Coefficients:  1.0 0.
% Perturbed parameters: a in [0.9,1.1], b in [2.3,2.7], c in [0.1,0.3]
...
function Buckling_Pontryagin()
	...
	% 	The uncertain parameter c belongs to [0.1,0.3];
	...
	f(1) = u(1)*x(2);
	f(2) = u(2)*x(1)-x(1)*x(1)*x(1)-2*x(2)+u(3);


	initpontryagin(f,p,x,u);

	cHeader = { 'a' 'b' 'c'	 };
	pontryagin(maximize,vcoeff,max_iter,delta,uVars,cHeader,gamma,tspan,tspanRev,x0,u_max,u_min,'Buckling_Pontryagin_max.csv',doPlot);
	pontryagin(minimize,vcoeff,max_iter,delta,uVars,cHeader,gamma,tspan,tspanRev,x0,u_max,u_min,'Buckling_Pontryagin_min.csv',doPlot);
