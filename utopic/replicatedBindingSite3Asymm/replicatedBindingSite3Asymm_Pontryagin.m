...
function replicatedBindingSite3Asymm_Pointryagin()
	...
	pontryagin(maximize,vcoeff,max_iter,delta,uVars,cHeader,gamma,tspan,tspanRev,x0,u_max,u_min,'replicatedBindingSite3Asymm_Pointryagin_max.csv',doPlot);
	pontryagin(minimize,vcoeff,max_iter,delta,uVars,cHeader,gamma,tspan,tspanRev,x0,u_max,u_min,'replicatedBindingSite3Asymm_Pointryagin_min.csv',doPlot);
