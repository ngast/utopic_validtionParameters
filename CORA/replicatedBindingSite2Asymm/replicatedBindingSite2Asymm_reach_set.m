...
function replicatedBindingSite2Asymm_reach_set(CORA_path)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 x0_= [0.0343 0.0979 0.1922 0.3365 0.3391]';
 T = 0.2;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
	...
	dy(1,1) = (-kBind1)*y(1)*y(2)+(-kBind2)*y(1)*y(2)+kUnbind1*y(3)+kUnbind2*y(4);
	dy(2,1) = (-kBind1)*y(1)*y(2)+(-kBind2)*y(1)*y(2)+(-kBind1)*y(2)*y(4)+kUnbind1*y(3)+(-kBind2)*y(2)*y(3)+kUnbind2*y(4)+kUnbind1*y(5)+kUnbind2*y(5);
	dy(3,1) = kBind1*y(1)*y(2)+(-kUnbind1)*y(3)+(-kBind2)*y(2)*y(3)+kUnbind2*y(5);
	dy(4,1) = kBind2*y(1)*y(2)+(-kBind1)*y(2)*y(4)+(-kUnbind2)*y(4)+kUnbind1*y(5);
	dy(5,1) = kBind1*y(2)*y(4)+kBind2*y(2)*y(3)+(-kUnbind1)*y(5)+(-kUnbind2)*y(5);
end
